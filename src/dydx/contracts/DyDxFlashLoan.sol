// Use 0.5.17+ commit.d19bba13 solidity compiler version
// Deploy the contract with initial 2 gwei  
...
contract Flashloan is DyDxFlashLoan {
    ...
    function getFlashloan(address flashToken, uint256 flashAmount) external payable {
